{ fetchFromGitHub, lib, stdenv, ffmpeg, cmake, libpng, pkg-config, libjpeg, fetchpatch
}:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    (fetchpatch {
      ...
      url = "https://github.com/dirkvdb/ffmpegthumbnailer/commit/c5a6e3e7793c5a256b4d232adf6e1ae8082e809f.patch";
      sha256 = "sha256-za9SjaWQ49UADwrok1RvUzVe+EMtMkOL0s9tasJFeLw=";
    })
  ];
